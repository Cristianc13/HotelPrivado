...
namespace HotelPrivado.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idVendedor,nombre,direccion,telefono,observacion,sueldo")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idVendedor,nombre,direccion,telefono,observacion,sueldo")] Vendedor vendedor)
        {
